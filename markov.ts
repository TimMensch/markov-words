...
function createWord(stats: Stats, wordLength: number) {
    // start by choosing the first two letters (wordLength is at least 3)
    let l1 = chooseLetter(stats.firstLetters),
...
export function generate(stats: Stats, wordLength: number, numberOfWords = 1) {
